...
<head>
	...
	<title>My Blog</title>
	<link type="text/css" rel="stylesheet" href="css/tether.css" />
	...
	<section id="banner-slider">
		<div id="carouselExampleControls" class="carousel carousel-fade slide" data-ride="carousel">
			...
			<a class="carousel-control-prev slider-control" href="#carouselExampleControls" role="button" data-slide="prev">
				<span class="fa fa-angle-left banner-slide-icons" aria-hidden="true"></span>
				<span class="sr-only">Previous</span>
			</a>
			<a class="carousel-control-next slider-control" href="#carouselExampleControls" role="button" data-slide="next">
				<span class="fa fa-angle-right banner-slide-icons" aria-hidden="true"></span>
